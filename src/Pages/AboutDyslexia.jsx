  ...
  return (
    <>
      ...
      <div className={`relative min-h-screen ${bgColor} flex flex-col items-center justify-center text-center px-6 py-10`}>
        ...
        >
          Dyslexia is a learning difference that makes reading and writing challenging for many children. It's not about intelligence, but how the brain processes letters and words.
          <br /><br />
          <span className={`font-bold ${gender === 'boy' ? 'text-blue-500' : 'text-pink-500'}`}>JoyVerse</span> is designed to help children with dyslexia by using engaging activities that adapt based on their emotions and abilities. 
          Whether it's learning to read or doing math puzzles, we make sure every child gets the help they need to succeed while having fun! 🌈🎮
          <br /><br />
          With the support of trained specialists, JoyVerse ensures that dyslexic children feel encouraged and motivated to learn and explore new worlds of knowledge. 🧸📚
        </motion.p>
      ...
      <footer className={`${footerBgColor} ${ftextColor} py-8 px-4 mt-2`}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6">
          ...
          <div className="flex gap-6">
            <a href="/AboutDyslexia" className="hover:underline hover:text-pink-600">About Dyslexia</a>
